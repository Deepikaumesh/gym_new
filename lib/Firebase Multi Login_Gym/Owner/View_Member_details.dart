...
class View_Member_details extends StatefulWidget {
  @override
  State<View_Member_details> createState() => _View_Member_detailsState();
}

class _View_Member_detailsState extends State<View_Member_details> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        ...
        stream: FirebaseFirestore.instance.collection('Member_Add_Data')
            .snapshots(),
