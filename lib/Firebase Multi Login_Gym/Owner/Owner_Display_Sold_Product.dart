...
class Owner_Display_Sold_Product extends StatefulWidget {
  @override
  State<Owner_Display_Sold_Product> createState() => _Owner_Display_Sold_ProductState();
}

class _Owner_Display_Sold_ProductState extends State<Owner_Display_Sold_Product> {
