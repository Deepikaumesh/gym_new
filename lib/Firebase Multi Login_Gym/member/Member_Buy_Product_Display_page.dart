...
class Member_Buy_Product_Display_Page extends StatefulWidget {
  @override
  State<Member_Buy_Product_Display_Page> createState() => _Member_Buy_Product_Display_PageState();
}

class _Member_Buy_Product_Display_PageState extends State<Member_Buy_Product_Display_Page> {
                        ...
                        onTap: (){
                          setState(() {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                builder: (context) => Member_Product_Buy_Page(price: document['price'], producr_name: document['name'],),
                              ),
                            );
                           //Member_Product_Buy_Page
                          });
                        },
                       child: Text("Buy",style: TextStyle(color: Colors.red.shade900,fontSize: 25,fontWeight: FontWeight.bold),),
