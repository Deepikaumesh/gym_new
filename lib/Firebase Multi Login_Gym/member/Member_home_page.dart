          ...
          child: Column(children: [
            ...
            ElevatedButton(
                style: ButtonStyle(
                    ...
                    minimumSize: MaterialStateProperty.all(Size(350, 50))),
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>Member_add_physical_details()));
                },
            ...
            ElevatedButton(
                style: ButtonStyle(
                    ...
                    minimumSize: MaterialStateProperty.all(Size(350, 50))),
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>video_Main_page()));
                },
            ...
            ElevatedButton(
                style: ButtonStyle(
                    ...
                    minimumSize: MaterialStateProperty.all(Size(350, 50))),
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>video_Entry_page()));
                },
                child: Text("Workout Videos test")),
            SizedBox(
              height: 20,
            ),
            ElevatedButton(
            ...
            ElevatedButton(
                style: ButtonStyle(
                    ...
                    minimumSize: MaterialStateProperty.all(Size(350, 50))),
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>Member_Buy_Product_Display_Page()));
            ...
            ElevatedButton(
                style: ButtonStyle(
                    ...
                    minimumSize: MaterialStateProperty.all(Size(350, 50))),
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>Member_Fee_Payment()));
...
//Member_Fee_Payment
            ...
            //         minimumSize: MaterialStateProperty.all(Size(350, 50))),
            //     onPressed: () {
            //       Navigator.push(context, MaterialPageRoute(builder: (context)=>Member_Payment_Details_Page()));
            //
            //     },
